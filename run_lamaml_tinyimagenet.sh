...
IMGNET='--data_path data/tiny-imagenet-200/ --log_every 100 --dataset tinyimagenet --cuda --log_dir logs/arith/'
SEEDS=(0 1 2)
GPU=3

for SEED in ${SEEDS[*]}; do
    ########## TinyImageNet Dataset Single-Pass ##########
    CUDA_VISIBLE_DEVICES=$GPU uv run main.py $IMGNET --model lamaml_cifar --expt_name lamaml --memories 400 --batch_size 10 --replay_batch_size 10 --n_epochs 1 \
